...
const block: Sb3BlockMetadata = {version: 1, shadow: true, comment: "comment-id"}
...
const scriptWithShadow: Sb3ScriptMetadata = {version: 1, shadow: true}
...
void [script, block, input, field, scriptWithShadow, fieldWithShadowId]
