...
export const createScratchFragment = (
  ...
  const selectedDefinitions = definitionsByCode(
    collectTopProcedureDefinitions(selectedScripts),
  )
  ...
  const sourceDefinitions = definitionsByCode(
    collectTopProcedureDefinitions(sourceScripts),
  )
