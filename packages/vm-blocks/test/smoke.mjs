...
const source = [{
  id: "example", opcode: "example", next: null, inputs: {VALUE: {block: "text", shadow: "text"}}, fields: {},
  shadow: false, topLevel: true,
}, {
  id: "text", opcode: "text", next: null, parent: "example", inputs: {}, fields: {TEXT: {value: "hello"}},
