...
const createFixtureRegistry = () => {
  ...
  registry.register({
    ...
    shape: "command",
    inputs: {
      NUMBER: {connection: "value", accepts: "number", default: {kind: "input", type: "number", value: 10}},
      MENU: {connection: "value", accepts: "string", default: {
        kind: "input", type: "block",
        value: {kind: "block", opcode: "menu", inputs: {}, fields: {VALUE: {kind: "field", type: "dropdown", value: "default"}}},
      }},
      CONNECTED: {connection: "value", accepts: "number", default: {kind: "input", type: "number", value: 1}},
      PROMOTE: {connection: "value", accepts: "string", default: {kind: "input", type: "string", value: "default"}},
      PRESERVED: {connection: "value", accepts: "number", default: {kind: "input", type: "number", value: 2}},
  ...
  registry.register({
    opcode: "menu", shape: "reporter", outputType: "string", inputs: {},
    fields: {VALUE: {type: "dropdown"}}, arguments: [{kind: "field", name: "VALUE"}],
  })
  registry.register({opcode: "reporter", shape: "reporter", outputType: "number", inputs: {}, fields: {}, arguments: []})
...
const partialFixture = (): Script[] => [{
  ...
  blocks: [{
    ...
    inputs: {
      ...
      MENU: {kind: "input", type: "block", value: {
        kind: "block", opcode: "menu", inputs: {},
        fields: {VALUE: {kind: "field", type: "dropdown", value: "chosen"}},
      }},
      CONNECTED: {kind: "input", type: "block", value: {
        kind: "block", opcode: "reporter", inputs: {}, fields: {},
      }},
      PROMOTE: {kind: "input", type: "empty", obscuredShadow: {
        kind: "input", type: "block", value: {
          kind: "block", opcode: "menu", inputs: {},
          fields: {VALUE: {kind: "field", type: "dropdown", value: "promoted"}},
        },
      }},
      PRESERVED: {kind: "input", type: "block", value: {
        kind: "block", opcode: "reporter", inputs: {}, fields: {},
      }, obscuredShadow: {kind: "input", type: "string", value: "kept"}},
      BODY: {kind: "input", type: "script", value: {
        kind: "script", blocks: [{kind: "block", opcode: "command", inputs: {}, fields: {}}],
      }},
      EXTRA: {kind: "input", type: "block", value: {
        kind: "block", opcode: "reporter", inputs: {}, fields: {},
      }},
    },
  }],
...
describe("materializeScripts", () => {
  it("generates Scratch VM-compatible default IDs", () => {
    ...
    const characters = new Set("!#%()*+,-./:;=?@[]^_`{|}~ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789")
  ...
  it("rejects duplicate existing IDs and invalid or colliding generated IDs", () => {
    const duplicate: Script[] = [{kind: "script", blocks: [
    ...
    const existing: Script[] = [{kind: "script", blocks: [
  ...
  it("uses resolved TurboWarp procedure defaults and reports invalid mutations", () => {
    ...
    const scripts: Script[] = [{kind: "script", blocks: [{
      kind: "block", opcode: "procedures_call", fields: {},
      inputs: Object.fromEntries(argumentIds.map(id => [id, {kind: "input", type: "empty"}])),
      mutation: {
        type: "procedure-call", proccode: "mix %n %s %b", argumentIds,
        warp: false, returnType: "statement",
      },
    }, {
      kind: "block", opcode: "procedures_prototype", fields: {},
      inputs: Object.fromEntries(argumentIds.map(id => [id, {kind: "input", type: "empty"}])),
      mutation: {
        type: "procedure-prototype", proccode: "mix %n %s %b", argumentIds,
    ...
    expect(prototype.inputs["number"]).toMatchObject({
      type: "block", value: {opcode: "argument_reporter_string_number", shadow: true},
    })
