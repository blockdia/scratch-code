...
const options = () => {
  let next = 1
  return {
    contextForBlock: (block: Parameters<typeof getTurboWarpBlockResolveContext>[0], {hasNext}: {hasNext: boolean}) =>
...
describe("materialize invariants across shared fixtures", () => {
  ...
  it("does not guess a primitive shadow from accepts without InputSpec.default", () => {
    ...
    const source: Script[] = [{kind: "script", blocks: [{
      kind: "block", opcode: "no-default", inputs: {}, fields: {},
    }]}]
  ...
  it("materializes recursive obscured shadows and rejects duplicate identities", () => {
    const registry = createBlockSpecRegistry<undefined>()
    registry.register({
      opcode: "root", shape: "command", fields: {}, arguments: [{kind: "input", name: "VALUE"}],
      inputs: {VALUE: {connection: "value", accepts: "string", default: {
        kind: "input", type: "block", value: {
          kind: "block", opcode: "menu", inputs: {}, fields: {},
        },
      }}},
    })
    registry.register({
      opcode: "menu", shape: "reporter", outputType: "string", inputs: {}, fields: {}, arguments: [],
    })
    const source: Script[] = [{kind: "script", blocks: [{
      kind: "block", opcode: "root", inputs: {VALUE: {
        kind: "input", type: "string", value: "active", obscuredShadow: {
          kind: "input", type: "block", value: {kind: "block", opcode: "menu", inputs: {}, fields: {}},
        },
      }}, fields: {},
    }]}]
    let next = 1
    ...
    const duplicate: Script[] = [{kind: "script", blocks: [
      {kind: "block", opcode: "menu", inputs: {}, fields: {}, metadata: {scratch: {id: "same"}}},
      {kind: "block", opcode: "menu", inputs: {}, fields: {}, metadata: {scratch: {id: "same"}}},
    ]}]
    expect(() => materialize(duplicate, registry, {
      contextForBlock: () => undefined,
